    ...
    items: [
      {
        ...
        text: "Excelente empresa de ar-condicionado em Ivoti. Fizeram a manutenção e a higienização do meu split. O técnico foi rápido, educado e o ar voltou a gelar como novo.",
      },
      {
        id: "test-2",
        author: "Empresa da Região",
        city: "Ivoti / RS",
        rating: 5,
        source: "Avaliação Google",
        text: "Fechamos o contrato de PMOC com a Beni Climatização para a nossa empresa e o serviço é impecável. Cuidam de tudo e garantem que o sistema opere perfeitamente.",
      },
      {
        id: "test-3",
        ...
        rating: 5,
        source: "Avaliação Google",
        text: "Técnicos muito qualificados! Precisava de uma instalação em um local alto que a maioria recusou. Eles resolveram com técnica de rapel e total segurança.",
      },
      {
        id: "test-4",
        author: "Proprietário de Comércio",
        city: "Ivoti / RS",
        rating: 5,
        source: "Avaliação Google",
        text: "A manutenção da nossa câmara fria foi feita por eles e não parou mais. Diagnóstico completo antes de agir. Muito profissionais e justos.",
      },
